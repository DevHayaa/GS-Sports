...
export default function Header() {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (cricketRef.current && !cricketRef.current.contains(event.target as Node)) {
        setIsCricketOpen(false)
      }
      if (customSportsRef.current && !customSportsRef.current.contains(event.target as Node)) {
            ...
            <div className="pt-4 space-y-2">
              ...
              {isCricketOpen && (
                <div className="pl-4 space-y-1">
                  <Link href="/cricket/bats" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                    Bats
                  </Link>
                  <Link href="/cricket/gloves" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                    Gloves (Batting gloves)
                  </Link>
                  <Link href="/cricket/pads" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                    Pads (Leg pads)
                  </Link>
                  <Link href="/cricket/thigh-pads" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                    Thigh pads
                  </Link>
                  <Link href="/cricket/inners" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                    Inners (Batting inners/inner gloves)
                  </Link>
                  <Link href="/cricket/abdominal-guard" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                    Abdominal guard (Box)
                  </Link>
                  <Link href="/cricket/bat-grips" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                    Grips (Bat grips)
                  </Link>
                </div>
              )}
              ...
              {isClothingOpen && (
                <div className="pl-4 space-y-1">
                  <Link href="/clothing/trousers" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                    Trousers
                  </Link>
                  <Link href="/clothing/tshirt" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                    T-Shirt
                  </Link>
                </div>
              )}

              <Link href="/shop" className="block px-3 py-2 text-sm font-medium text-gray-700 uppercase hover:bg-gray-50 rounded-lg transition-colors">
                SHOP ALL
              </Link>
              ...
              {isCustomSportsOpen && (
                <div className="pl-4 space-y-1">
                  <Link href="/custom-sports" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                    Get Custom Sports Quote
                  </Link>
                </div>
              )}

                 <Link href="/about" className="block px-3 py-2 text-sm font-medium text-gray-700 uppercase hover:bg-gray-50 rounded-lg transition-colors">
                ABOUT
              </Link>

              <Link href="/contact" className="block px-3 py-2 text-sm font-medium text-gray-700 uppercase hover:bg-gray-50 rounded-lg transition-colors">
                CONTACT
              </Link>

              <Link href="/login" className="block px-3 py-2 text-sm font-medium text-gray-700 uppercase hover:bg-gray-50 rounded-lg transition-colors">
                LOGIN
              </Link>
            </div>
          </nav>
